import { PartialSynthesizeSpeechInput, promise, textToSpeech } from '../../../index'
...
describe('text to speech function', () => {
  test('should use AWS SDK to transform text to speech', async () => {
    ...
    const result = await textToSpeech(mockPolly, {} as unknown as PartialSynthesizeSpeechInput)(textText)
    // @ts-ignore
